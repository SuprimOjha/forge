...
int runProject() {
    ...
    if (project.type == "C++ / CMake") {
        ...
        if (project.cmakeConfigured) {
            ...
            std::cout
                << "  Status: Not Configured (missing build/ directory or CMakeCache.txt)\n";
        }
    }
    ...
    if (project.type == "C++ / CMake") {
        ...
        if (project.cmakeConfigured) {
            ...
            std::cout
                << "  [OK] CMake build directory configured\n";

        } else {

            std::cout
                << "  [ERROR] CMake build directory not configured\n";
        }
    }
